...
const config: Config = {
  ...
  url: 'https://simons36.github.io/docusaurus-site/',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: 'Cybersecurity',
              to: '/docs/Cybersecurity/overview',
            }
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Simao's CS Notes. Built with Docusaurus.`,
    },
    prism: {
